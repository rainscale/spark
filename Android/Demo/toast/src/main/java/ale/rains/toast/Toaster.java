...
import ale.rains.toast.config.IToastInterceptor;
import ale.rains.toast.config.IToastStrategy;
import ale.rains.toast.config.IToastStyle;
import ale.rains.toast.style.BlackToastStyle;
import ale.rains.toast.style.CustomToastStyle;
import ale.rains.toast.style.LocationToastStyle;
