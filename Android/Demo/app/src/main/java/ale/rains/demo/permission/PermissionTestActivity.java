package ale.rains.demo.permission;
...
import ale.rains.permission.OnPermissionCallback;
import ale.rains.permission.Permission;
import ale.rains.permission.XXPermissions;
 ...
 *    desc   : 权限申请演示
 */
public final class PermissionTestActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.btn_main_request_single_permission) {
                    ...
                    .request(new OnPermissionCallback() {
                        ...
                        public void onGranted(@NonNull List<String> permissions, boolean allGranted) {
                            ...
                            toast(String.format(getString(R.string.demo_obtain_permission_success_hint),
                                    PermissionNameConvert.getPermissionString(PermissionTestActivity.this, permissions)));
                        }
                    });
            ...
            view.postDelayed(new Runnable() {
                ...
                @Override
                public void run() {
                    XXPermissions.with(PermissionTestActivity.this)
