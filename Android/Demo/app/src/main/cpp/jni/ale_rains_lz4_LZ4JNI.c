...
#include "lz4.h"
#include "lz4hc.h"
#include "ale_rains_lz4_LZ4JNI.h"

static jclass OutOfMemoryError;

/*
 * Class:     ale_rains_lz4_LZ4
 * Method:    init
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_ale_rains_lz4_LZ4JNI_init
 ...
 */
JNIEXPORT jint JNICALL Java_ale_rains_lz4_LZ4JNI_LZ4_1compress_1limitedOutput
 ...
 */
JNIEXPORT jint JNICALL Java_ale_rains_lz4_LZ4JNI_LZ4_1compressHC
 ...
 */
JNIEXPORT jint JNICALL Java_ale_rains_lz4_LZ4JNI_LZ4_1decompress_1fast
 ...
 * Signature: ([BLjava/nio/ByteBuffer;II[BLjava/nio/ByteBuffer;II)I
 */
JNIEXPORT jint JNICALL Java_ale_rains_lz4_LZ4JNI_LZ4_1decompress_1safe
  (JNIEnv *env, jclass cls, jbyteArray srcArray, jobject srcBuffer, jint srcOff, jint srcLen, jbyteArray destArray, jobject destBuffer, jint destOff, jint maxDestLen) {
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_ale_rains_lz4_LZ4JNI_LZ4_1compressBound
